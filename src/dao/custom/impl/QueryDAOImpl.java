...
public class QueryDAOImpl implements QueryDAO {
    ...
    public  ArrayList<CustomDTO> getOrderDetailsFromOrderID(String oid) throws SQLException, ClassNotFoundException {
        ...
        while (rst.next()) {
            allData.add(new CustomDTO(rst.getString("oid"), LocalDate.parse(rst.getString("date")), rst.getString("customerID"), rst.getString("itemCode"), rst.getInt("qty"), rst.getDouble ("unitPrice")));
        }
        return allData;
    }
